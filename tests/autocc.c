...
static uint32_t array[256] = {0x00000000,0x00000001,0x00000002,0x00000003,0x00000004,0x00000005,0x00000006,0x00000007,0x00000008,0x00000009,0x0000000A,0x0000000B,0x0000000C,0x0000000D,0x0000000E,0x0000000F,
...
void _kernel_(uint32_t id, uint32_t core_num){
    ...
    for (int i=0;i<iterations;i++){
        ...
        dec_fifo_cleanup(1);
        ///PROCESS A///
        uint32_t mask = secret & 0x00000FF;
        secret = secret >> channel_width;
        void * addr = &array[mask];
        ...
        recovered = recovered | (res << (i*channel_width));
